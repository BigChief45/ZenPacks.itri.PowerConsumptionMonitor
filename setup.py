...
NAME = "ZenPacks.itri.PowerConsumptionMonitor"
VERSION = "1.0.0"
AUTHOR = "Jaime Alvarez (jalvarez@itri.org.tw"
LICENSE = "GPL"
NAMESPACE_PACKAGES = ['ZenPacks', 'ZenPacks.itri']
PACKAGES = ['ZenPacks', 'ZenPacks.itri', 'ZenPacks.itri.PowerConsumptionMonitor']
INSTALL_REQUIRES = ['ZenPacks.itri.ServerMonitor', 'ZenPacks.zenoss.Dashboard']
COMPAT_ZENOSS_VERS = ""
PREV_ZENPACK_NAME = ""
# STOP_REPLACEMENTS
################################
